...
export default function ConfirmationPage() {
      ...
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#ffaa1d] mx-auto mb-4" />
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <Card className="max-w-md bg-black border-2 border-[#ffaa1d]">
          ...
          <CardContent>
            <p className="text-gray-400 mb-4">{error || 'Assignment not found'}</p>
            <div className="flex gap-2">
              <Button onClick={() => router.push('/checkout')} className="bg-[#ffaa1d] text-black hover:bg-[#ff9500]">
                Back to Checkout
              </Button>
  ...
  return (
    <div className="min-h-screen bg-black">
      <header className="border-b border-[#ffaa1d] bg-white">
        <div className="container mx-auto px-4 py-4">
          <a href="/" className="text-2xl font-bold text-[#ffaa1d]">
            RentMe
          </a>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Your courier service has been successfully assigned to your booking.</p>
          </div>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="font-semibold text-green-500 capitalize">
          ...
          <p className="text-gray-400 mb-6">Your payment was successful and courier assigned.</p>
